          ...
          <div className="intro__wrap">
            ...
            <div className="intro__content">
              ...
              <p className="intro__text">
                Welcome to our cozy café, where every cup of coffee is brewed
                with love and every dish is crafted to delight your taste buds.
                Whether you're here for a quick bite or a leisurely meal, we
                promise a warm atmosphere and exceptional service that will make
            ...
            <div className="about__wrap">
              <div className="about__content">
                ...
                <p className="about__text">
                  ...
                  friendly and welcoming atmosphere. Our team is passionate
                  about serving quality coffee and freshly made pastries.
                </p>
                <p className="about__text">
        ...
        <section className="feedback">
          <div className="feedback__wrap">
            <p className="feedback__text">
              Wake Up is a gem! The coffee is superb, and the ambiance is cozy
              and inviting. The staff is incredibly friendly and attentive. I
              had a wonderful experience and will definitely return. Thank you,
              Wake Up!
            </p>
